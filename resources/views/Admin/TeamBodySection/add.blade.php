                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="fb" id="fb"  class="form-control{{ $errors->has('fb') ? ' is-invalid' : '' }}" required autofocus value="www.facebook.com">
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="twitter" id="twitter"  class="form-control{{ $errors->has('twitter') ? ' is-invalid' : '' }}" required autofocus value="www.twitter.com">
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="instagram" id="instagram"  class="form-control{{ $errors->has('instagram') ? ' is-invalid' : '' }}" required autofocus value="www.instagram.com">
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="pinterest" id="pinterest"  class="form-control{{ $errors->has('pinterest') ? ' is-invalid' : '' }}" required autofocus value="www.pinterest.com">
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="googleplus" id="googleplus"  class="form-control{{ $errors->has('googleplus') ? ' is-invalid' : '' }}" required autofocus value="www.plus.google.com">
