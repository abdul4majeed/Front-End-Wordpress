        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('projectHeaderProjectSection.store') }}" enctype="multipart/form-data">
                            @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                    <input type="text" name="tag" id="tag"  class="form-control{{ $errors->has('tag') ? ' is-invalid' : '' }}" required autofocus>
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="home_page" id="home_page"  class="form-control{{ $errors->has('home_page') ? ' is-invalid' : '' }}"  autofocus>
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="file" name="url" id="url" autofocus>
